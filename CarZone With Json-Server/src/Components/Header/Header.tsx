    ...
    <header className="w-full bg-gray-900/40 backdrop-blur-md text-gray-200 shadow-md fixed top-0 left-0 z-50">
      ...
      {open && (
        <div className="md:hidden bg-gray-800 px-6 py-4 space-y-3">
          <a href="#home" className="block hover:text-red-400 text-3xl">Home</a>
          <a href="#models" className="block hover:text-red-400 text-3xl">Models</a>
          <a href="#services" className="block hover:text-red-400 text-3xl">Services</a>
          <a href="#about" className="block hover:text-red-400 text-3xl">About</a>
          <a href="#contact" className="block hover:text-red-400 text-3xl">Contact</a>
