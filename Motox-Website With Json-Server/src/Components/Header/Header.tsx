  ...
  return (
    <header className="w-full bg-gray-900/40 backdrop-blur-md text-gray-200 shadow-md fixed top-0 left-0 z-50">
      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        ...
        {/* Contact / Call */}
        <div className="hidden md:flex items-center gap-2 text-black bg-gradient-to-r from-red-600 via-red-50 to-red-500 px-4 py-2 rounded-lg cursor-pointer hover:bg-red-600 transition">
          <FaPhoneAlt />
