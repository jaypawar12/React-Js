    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-xl mx-auto mb-12">
          <p className="inline-block text-yellow-600 uppercase tracking-wide font-medium border-b-2 border-yellow-500 mb-3">
            Donation
          </p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex bg-white shadow-lg rounded-lg overflow-hidden p-6">
            ...
            <div className="flex flex-col items-center text-center mr-6 w-20">
              ...
              <div className="relative h-80 w-18 bg-gray-200 rounded-lg overflow-hidden mb-2 flex items-end">
